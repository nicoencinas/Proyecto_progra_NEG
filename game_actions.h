...
/**
 * @brief Ejecuta la acción de moverse hacia la sala anterior (Norte)
 * @author 
 * * Consulta la conexión norte del espacio actual y, si existe, actualiza la 
...
/**
 * @brief Ejecuta la acción de moverse hacia el Oeste
 * @author MAR
 * * Consulta la conexión oeste del espacio actual y, si existe, actualiza la 
 * posición del jugador.
 * @param game Puntero a la estructura del juego
 */
...
/**
 * @brief Ejecuta la acción de moverse hacia el Este
 * @author MAT
 * * Consulta la conexión este del espacio actual y, si existe, actualiza la 
 * posición del jugador.
 * @param game Puntero a la estructura del juego
 */
