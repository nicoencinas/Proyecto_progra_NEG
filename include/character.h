 ...
 * @author MAT
 * @param character Puntero al personaje
 * @param id id del jugador al que sigue
 * @return OK o ERROR
 */
...
/**
 * @brief Obtiene la cantidad de daño que puede infligir un personaje
 * @author MAR
 * * @param character Puntero a la estructura del personaje
 * @return Valor entero con el daño del personaje o -1 en caso de error (si el puntero es NULL)
 */
int character_get_damage(Character *character);

/**
 * @brief Establece el valor de daño para un personaje específico
 * @author MAR
 * * @param character Puntero a la estructura del personaje
 * @param d Nuevo valor de daño a asignar
 * @return OK si la operación se realiza con éxito, ERROR en caso de que el puntero sea nulo o el valor sea inválido
 */
Status character_set_damage(Character *character, int d);
