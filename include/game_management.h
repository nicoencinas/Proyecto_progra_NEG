...
/**
 * @brief Lee los datos acerca del fichero y carga los personajes (NPCs/Enemigos)
 * @author MAR
 * * @param game Puntero al juego
 * @param filename Nombre del fichero de datos
 * @return OK si se cargan correctamente, ERROR en caso contrario
 */
Status game_reader_load_characters(Game *game, char *filename);

/**
 * @brief Lee los datos del fichero para inicializar el modo multijugador
 * @author MAR
 * * @param game Puntero al juego
 * @param filename Nombre del fichero de datos
 * @return OK si la carga es exitosa, ERROR en caso contrario
 */
