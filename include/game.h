...
/**
 * @brief Crea una nueva instancia de juego, reservando memoria e inicializando sus componentes
 * @author Profesores PPROG
 * * @return Puntero a la nueva estructura Game o NULL en caso de error
 */
Game* game_create();

/**
 * @brief Libera la memoria de una instancia de juego y de todos sus elementos internos
 * @author Profesores PPROG
 * * @param game Puntero al juego que se desea destruir
 * @return OK si se libera correctamente, ERROR en caso contrario
 */
Status game_destroy(Game *game);

/**
 * @brief Obtiene un puntero a un espacio específico del juego mediante su ID
 * @author Profesores PPROG
...
/**
 * @brief Obtiene un puntero a un personaje específico del juego mediante su ID
 * @author MAR
 * * @param game Puntero al juego
 * @param id Identificador del personaje a buscar
 * @return Puntero al personaje encontrado o NULL si no existe
 */
...
/**
 * @brief Actualiza la ubicación del jugador a un nuevo espacio
 * @author Profesores PPROG
 * * @param game Puntero al juego
 * @param id Identificador del nuevo espacio de destino
 * @return OK si se actualiza correctamente, ERROR en caso contrario
 */
Status game_set_player_location(Game *game, Id id);

/**
 * @brief Obtiene el último comando que ha sido procesado en el juego
 * @author Profesores PPROG
 * * @param game Puntero al juego
 * @return Puntero a la estructura Command del último comando
 */
Command *game_get_last_command(Game *game);

/**
 * @brief Establece o actualiza el último comando ejecutado en el sistema
 * @author Profesores PPROG
 * * @param game Puntero al juego
 * @param command Puntero al comando a registrar
 * @return OK o ERROR
 */
Status game_set_last_command(Game *game, Command *command);

/**
 * @brief Comprueba si la partida ha finalizado (victoria, derrota o salida)
 * @author Profesores PPROG
 * * @param game Puntero al juego
...
/**
 * @brief Cambia el estado de finalización del juego
 * @author Profesores PPROG
 * * @param game Puntero al juego
 * @param finished Nuevo estado de finalización (TRUE/FALSE)
 * @return OK o ERROR
 */
Status game_set_finished(Game *game, Bool finished);

/**
 * @brief Imprime por pantalla el estado actual de todos los elementos del juego
 * @author Profesores PPROG
 * * Esta función es de utilidad para depuración, mostrando espacios, objetos y jugador.
 * @param game Puntero al juego
 */
