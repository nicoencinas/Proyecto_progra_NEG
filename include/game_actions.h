...
/**
 * @brief Recluta a un character si es friendly
 * @author MAR
 * @param game Puntero a la estructura del juego
 */
...
/**
 * @brief Determina quien es golpeado
 * @author MAR
 */
Status hit_party(Game *game, Player *pl, int total_members, int enemy_dmg);

/**
 * @brief Ejecuta el comando USE
 * @author MAR
 */
Status game_actions_use(Game *game);

/**
 * @brief Carga un fichero con los datos que guardaste de la partida
 * @author MAR
...
/**
 * @brief Guarda en un fichero la partida actual
 * @author JOEL
 * @param game puntero a la estructura Game
 */
...
/**
 * @brief Gestiona la acción de colaboración entre jugadores o personajes
 * @author MAR
 * * @param game Puntero a la estructura del juego
 * @return OK si la colaboración se realiza con éxito, ERROR en caso contrario
 */
